...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/src/install/rlr_camera"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rlr_camera/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rlr_camera/environment/path.sh"
